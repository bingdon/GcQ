package com.yyb.gcquan.support.time;
...
import com.yyb.gcquan.bean.ItemBean;
...
public class TimeUtility {
	...
	private static String JUST_NOW = GcApplication.getInstance().getString(
			R.string.justnow);
	private static String MIN = GcApplication.getInstance().getString(R.string.min);
	private static String HOUR = GcApplication.getInstance().getString(
			R.string.hour);
	private static String DAY = GcApplication.getInstance().getString(R.string.day);
	private static String MONTH = GcApplication.getInstance().getString(
			R.string.month);
	private static String YEAR = GcApplication.getInstance().getString(
			R.string.year);

	private static String YESTER_DAY = GcApplication.getInstance().getString(
			R.string.yesterday);
	private static String THE_DAY_BEFORE_YESTER_DAY = GcApplication.getInstance()
			.getString(R.string.the_day_before_yesterday);
	private static String TODAY = GcApplication.getInstance().getString(
			R.string.today);

	private static String DATE_FORMAT = GcApplication.getInstance().getString(
			R.string.date_format);
	private static String YEAR_FORMAT = GcApplication.getInstance().getString(
